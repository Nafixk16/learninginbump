...
import QuizeGame from '../screens/quizGame';
...
import MedicalHistory from '../screens/medical';
...
function SignUpLoginStack(props) {
  return (
...
function DietPlanStack(props) {
  return (
    <Stack.Navigator mode="card" headerMode="screen">
      <Stack.Screen name="Diet Plan" component={DietPlan} />
    </Stack.Navigator>
  );
}
